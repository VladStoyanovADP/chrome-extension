...
//   }
  ...
  var player = document.getElementsByClassName("videoPlayer-Rumble-cls")[0];
  console.log(player)
...
function AddScreenshotButton() {
  var ytpRightControls = document.querySelector(
    'div[style="width: 100%; height: 30px; margin: 0px; padding: 0px 9px; background: none; opacity: 1; font: 12px sans-serif; box-sizing: border-box; border: none; visibility: visible; text-size-adjust: auto; text-decoration: none; color: inherit; position: absolute; bottom: 0px; display: block; cursor: pointer; z-index: 1010; user-select: none; -webkit-tap-highlight-color: transparent; --darkreader-inline-bgimage:none; --darkreader-inline-bgcolor: initial; --darkreader-inline-border-top: initial; --darkreader-inline-border-right: initial; --darkreader-inline-border-bottom: initial; --darkreader-inline-border-left: initial; --darkreader-inline-color: inherit;"]'
  );
  if (ytpRightControls) {
